...
export default function VehicleManagment() {
  ...
  const { vehicles, activeVehicles, inActiveVehicles, inMaintenanceVehicles } =
    data || {};
      ...
      >
        ...
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }}>
          <OutlinedCard
            text={"InActive"}
            icon={InActiveLogo}
            secText={inActiveVehicles.count}
          />
        </Grid>
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }}>
          <OutlinedCard
            text={"In Maintenance"}
            icon={MaintenenceLogo}
            secText={inMaintenanceVehicles.count}
          />
        </Grid>
      </Grid>
