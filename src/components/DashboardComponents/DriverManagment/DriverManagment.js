    ...
    >
      ...
      >
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }}   >
          <OutlinedCard text={"All Drivers"} icon={InActiveLogo} secText={drivers.count}  />
        </Grid>
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }} >
          <OutlinedCard text={"On Duty"} icon={ActiveLogo} secText={activeDrivers.count}/>
        </Grid>
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }}>
          <OutlinedCard text={"Off Duty"} icon={InActiveLogo} secText={inActiveDrivers.count}/>
        </Grid>
        <Grid item xs={13} sm={6} md={2.98} sx={{ flexShrink: 1 }}>
          <OutlinedCard text={"Available"} icon={MalfunctioningLogo} secText={drivers.count}/>
        </Grid>
      </Grid>
